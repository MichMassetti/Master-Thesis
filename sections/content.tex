...
%Dos Attack, problem in implementation, locked funds in the contract
...
The other property deals with claimProjectFunds(). The function has some require(), so the property in this case is a precondtion. 
