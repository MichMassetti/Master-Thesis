...
\autoref{lst:AkuProps} shows in practical the expressed properties.

\begin{lstlisting} [caption={Aku properties}, label={lst:AkuProps}]
    Property 1 postcondition refered to function processRefunds():  _refundProgress<=_bidIndex
