...
Dies ist die Vorlage für Abschlussarbeiten am Institut für Informationssicherheit und Verlässlichkeit (KASTEL) des Karlsruher Instituts für Technologie (KIT). Es basiert auf der Vorlage für Abschlussarbeiten am Lehrstuhl Software Design andQuality (SDQ) am Institut für Datenorganisation und Programmstrukturen (IPD).
...
`logos/`
--------
In diesem Verzeichnis befindet sich das KIT-Logo als PDF und EPS. 
...
English Version
===============
This is a template for student's final theses at the Institute of Information Security and Dependability (KASTEL) at Karlsruhe Institute of Technology (KIT). It is based on the template for student's final theses at the chair of Software Design and Quality (SDQ) at the Institute of Program Structures and Data Organization (IPD)
...
`logos/`
--------
This directory contains the KIT logo in PDF and EPS.
