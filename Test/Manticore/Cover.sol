...
contract Blacksmith {
    ...
    function deposit(uint256 _amount) public{
        ...
        updatePool();
        minersReward[msg.sender]=minersReward[msg.sender].add(pool.accRewardsPerToken);
        minersRewardEff[msg.sender]=minersRewardEff[msg.sender].add(pooleff.accRewardsPerToken);
    }
